  ...
  return (
    <div className="space-y-10 pb-14 pt-6 sm:pt-10">
      <section className="space-y-4">
        ...
        <h1 className="section-title">Let us build something solid</h1>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <article className="notion-card space-y-3">
          ...
          <p className="text-base text-zinc-700">{profileFacts.location}</p>
          <a
          ...
          <a
            ...
            className="inline-block rounded-xl border border-line px-4 py-2.5 text-sm font-medium"
          >
            Book a slot
          </a>
        </article>
        ...
        <article className="notion-card space-y-3">
          <h2 className="text-2xl font-semibold">Also find me on</h2>
          <a
      ...
      <section className="notion-card space-y-3">
        <h2 className="text-2xl font-semibold">Most common requests</h2>
        <ul className="grid gap-2 sm:grid-cols-2">
          {coreServices.map((service) => (
            <li key={service} className="rounded-xl border border-line bg-zinc-50 px-3 py-2 text-sm">
              {service}
            </li>
          ))}
        </ul>
